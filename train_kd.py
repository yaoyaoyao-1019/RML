...
parser.add_argument('--save_path', type=str,
                    default='/home/yao/code/Nasty-Teacher-main/cheap_exp/TinyImage/kd_cheap_resnet50/resnet18')
...
if __name__ == "__main__":
    ...
    elif params.model_name == 'resnet8':
    ...
    #  vgg family
        ...
        model = LeNet(num_class=num_class)
    ...
    #  vgg family
    elif params.teacher_model == 'vgg8':
        teacher_model = vgg8_bn(num_classes=num_class)
    elif params.teacher_model == 'vgg13':
        teacher_model = vgg13_bn(num_classes=num_class)

    # wrn fanmily
    elif params.teacher_model == 'wrn16':
        teacher_model = wrn_16_2(num_classes=num_class)
    elif params.teacher_model == 'wrn40':
        teacher_model = wrn_40_2(num_classes=num_class)
